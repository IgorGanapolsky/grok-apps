...
async function run() {
  ...
  ws.onopen = async () => {
    try {
      ...
      console.log(`Navigating to correct dashboard: ${dashboardUrl}`);
      ...
      writeFileSync("/Users/igorganapolsky/workspace/git/igor/grok-apps/android/Agent-Bill/agentbill_dashboard_actual.png", buffer);
