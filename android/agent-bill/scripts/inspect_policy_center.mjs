...
async function run() {
  ...
  ws.onopen = async () => {
    try {
      ...
      console.log("Waiting 10s for Policy Center page to load...");
      ...
      // Take a screenshot
      console.log("Capturing screenshot of Policy Center...");
      const screenshotResult = await sendCommand("Page.captureScreenshot", { format: "png" });
      const buffer = Buffer.from(screenshotResult.data, "base64");
      const screenshotPath = "/Users/igorganapolsky/workspace/git/igor/grok-apps/android/Agent-Bill/policy_status_actual.png";
